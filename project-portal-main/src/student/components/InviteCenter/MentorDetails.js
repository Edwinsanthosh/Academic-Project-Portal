  ...
  <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-50 text-indigo-700 border border-indigo-200">
    ...
    >
      <path
        ...
        strokeWidth={2}
        d="M16 12H8m8-4H8m8 8H8m12-12H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2z"
      />
    </svg>
    {email}
  </div>
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          {mentor?.specialized_in ? (
            <div className="inline-flex items-center bg-gradient-to-r from-indigo-50 to-purple-50 text-indigo-700 text-sm px-4 py-2 rounded-lg font-medium border border-indigo-100">
